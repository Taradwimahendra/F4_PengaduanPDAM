...
-- =========================================================
-- 2. PEMBUATAN TABEL LOGGING & KEAMANAN (SESUAI MODUL)
-- =========================================================
...
-- =========================================================
-- 3. PEMBUATAN TRIGGER PADA TABEL PENGADUAN (SESUAI MODUL)
-- =========================================================
...
-- H. SP Filter Laporan Rekap Pengaduan
...
BEGIN
    ...
    IF @Status = '' OR @Status = 'semua'
    BEGIN
        SELECT 
            PengaduanID         AS [ID],
            Tanggal_Pengaduan   AS [Tanggal],
            Nama_Pelapor        AS [Pelapor],
            NoTelepon           AS [No Telepon],
            Alamat              AS [Alamat],
            NamaKategori        AS [Kategori],
            Judul_Laporan       AS [Judul],
            Deskripsi_Laporan   AS [Deskripsi],
            StatusPengaduan     AS [Status]
        FROM View_LaporanPengaduan
        WHERE CAST(Tanggal_Pengaduan AS DATE) >= @Dari 
